...
С использованием найденного коэффициента $A$ в процедуре
\texttt{approximate-solution} расчитывается и приближённое решения
исходного уравнения \eqref{deq} внутри неоднородного слоя:
...
и \texttt{GNU Emacs}. Для автоматического определения зависимостей
