...
\bibitem{polyanin03}
  А.~Д.~Полянин, А.~В.~Манжиров. \emph{Справочник
    по интегральным уравнениям}. М.: Физматлит, 2003.
\bibitem{demidovich67}
  Б.~П.~Демидович, И.~Ф.~Марон, Э.~З.~Шувалова. \emph{Численные методы
    анализа. Приближение функций, дифференциальные и интегральные
    уравнения}. М.: Наука, 1967.
\bibitem{bahvalov01}
  Н.~С.~Бахвалов, Н.~П.~Жидков, Г.~М.~Кобельков. \emph{Численные
